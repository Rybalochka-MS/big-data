...
if __name__ == "__main__":
    ...
    print(word_count(docs))
    print()

    print("word count using map_reduce function")
    print(map_reduce(docs, wc_mapper, wc_reducer))
    print()
    ...
    mapp = partial(matrix_multiply_mapper, 3)
    reduce = partial(matrix_multiply_reducer, 3)

    print("map-reduce matrix multiplication")
    print("entries:", entries)
    print("result:", map_reduce(entries, mapp, reduce))
